...
public class LoggingInterceptor implements ClientHttpRequestInterceptor {
	...
	public ClientHttpResponse intercept(HttpRequest request, byte[] body, ClientHttpRequestExecution execution)
		...
		//Need to change the user agent, the default is "Java/1.8.0_111" and Tinder would deny the request
...
//		Iterator<String> responseHeaderIterator = responseHeaders.keySet().iterator();
...
//	        LOGGER.info("Response body -> " + scanner.useDelimiter("\\A").next());
//	    }
